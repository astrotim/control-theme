 ...
 */
	...
	/**
	 * Custom length and read more
	 *
	 * @example ctrl_excerpt('ctrl_excerptlength_post', 'ctrl_excerpt_readmore', ' ');
	 */
	 ...
	 * Get excerpt by ID
	 *
	 * @link [http://wordpress.stackexchange.com/questions/26729/get-excerpt-using-get-the-excerpt-outside-a-loop/54629#54629]
	 */
	function ctrl_get_excerpt_by_id($post_id){
